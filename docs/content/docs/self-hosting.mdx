...
You can also override release source inside the installer:
...
Download the tarball for your platform from your public distribution [Releases page](https://github.com/patrickaigbogun/pipelyn-distribution/releases), extract it, and run the binary directly.
